                    ...
                    <div data-v-37f647ee="" class="container">
                        ...
                        <div class="container mt-4">
                            <div class="row">
                                ...
                                $course_conditions = array_map(function ($course) use ($mysqli) {
                                    return "courses LIKE '%" . $mysqli->real_escape_string($course) . "%'";
                                }, $courses);

                                $course_conditions = implode(" OR ", $course_conditions);
                                $sql = "SELECT id, title, video, description, uploader, courses, timestamp FROM videos WHERE is_deleted = 0 AND ($course_conditions) ORDER BY timestamp DESC";
                                ...
                                {
                                    $today = time();
                                    $diff = $today - strtotime($timestamp);
                                ...
                                ?>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="card mb-4 box-shadow custom-card" data-toggle="modal" data-target="#videoModal_<?php echo $id; ?>">
                                            <?php
                                            $videoThumbnail = getVideoThumbnailUrl($row['video']);
                                            $timeDifference = getTimeDifference($row['timestamp']);
                                            ?>
                                ...
                                <?php endwhile; ?>
                                <?php if ($query_approved->num_rows === 0) : ?>
                                    <div class="col-md-12">
                                        <div class="alert alert-warning" role="alert">
                                            No videos found for the selected courses.
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
