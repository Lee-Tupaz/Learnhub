...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $video_link = trim($_POST['add_video']);
  $courses = $_POST['courses'];

  // To check if any courses are selected
  if (!empty($courses)) {
    // Convert courses array to a comma-separated string for SQL
    $courses_list = implode(', ', $courses);

    // Insert into videos table
    $insert_query = "INSERT INTO videos (title, video, description, uploader, courses, timestamp) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    // Bind parameters
    $stmt->bind_param("ssssss", $video_title, $video_link, $video_description, $uploader, $courses_list, $timestamp);
          ...
          <div data-v-37f647ee="" class="container">
            ...
            <div class="container">
              <div class="col-md-9 offset-md-2 form">
                <form id="videoForm" action="add_video.php" method="post" enctype="multipart/form-data">
                  <h2 class="text-center">Add Video</h2><br>

                  <div class="form-group">
                    <label for="title">Video Title:</label>
                    <textarea class="form-control adjustable-input" placeholder="Enter Video Title" name="video_title" id="video_title" rows="1" autocomplete="off" required></textarea>
                  </div>

                  <div class="form-group">
                    <label for="">Video Description:</label>
                    <textarea class="form-control adjustable-input" placeholder="Enter Video Description" name="video_description" id="video_description" rows="1" autocomplete="off" required></textarea>
                  </div>

                  <div class="form-group">
                    <label for="">Youtube Video Link:</label>
                    <textarea class="form-control adjustable-input" placeholder="Enter Youtube Video Link" name="add_video" id="add_video" rows="1" autocomplete="off" required></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <strong>SCHOOL OF COMPUTING</strong><br><br>
                        <label><input type="checkbox" name="courses[]" value="Cloud Computing"> Cloud Computing</label><br>
                        <label><input type="checkbox" name="courses[]" value="Data Science"> Data Science</label><br>
                        <label><input type="checkbox" name="courses[]" value="Game Development"> Game Development</label><br>
                        <label><input type="checkbox" name="courses[]" value="Software Engineering"> Software Engineering</label><br>
                        <label><input type="checkbox" name="courses[]" value="Web Development"> Web Development</label><br>
                      </div>
                      <div class="col-md-4">
                        <strong>SCHOOL OF DESIGN</strong><br><br>
                        <label><input type="checkbox" name="courses[]" value="Animation"> Animation</label><br>
                        <label><input type="checkbox" name="courses[]" value="Fashion Design and Technology"> Fashion Design and Technology</label><br>
                        <label><input type="checkbox" name="courses[]" value="Film and Visual Effects"> Film and Visual Effects</label><br>
                        <label><input type="checkbox" name="courses[]" value="Multimedia Arts and Design"> Multimedia Arts and Design</label><br>
                        <label><input type="checkbox" name="courses[]" value="Music Production and Sound Design"> Music Production and Sound Design</label><br>
                      </div>
                      <div class="col-md-4">
                        <strong>SCHOOL OF BUSINESS AND LIBERAL ARTS</strong><br><br>
                        <label><input type="checkbox" name="courses[]" value="Accountancy"> Accountancy</label><br>
                        <label><input type="checkbox" name="courses[]" value="E-Management"> E-Management</label><br>
                        <label><input type="checkbox" name="courses[]" value="Marketing Management"> Marketing Management</label><br>
                        <label><input type="checkbox" name="courses[]" value="Psychology"> Psychology</label><br>
                        <label><input type="checkbox" name="courses[]" value="Real Estate Management"> Real Estate Management</label><br>
                      </div>
                    </div>
                  </div>
                  ...
                  ?>
                  <center><input type="submit" class="btn btn-primary" name="add_submit" value="Upload"></button></center>
                </form>
              </div>
            </div>
          </div>
