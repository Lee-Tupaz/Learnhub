...
if (isset($_GET['deleteid'])) {
  ...
  // Soft Delete record in videos table
  $update_query = "UPDATE videos SET is_deleted = 1 WHERE id = ? AND is_deleted = 0";
  ...
  // Redirect back to professor_videos.php after deletion
      ...
      <div data-v-37f647ee="" class="content-page">
        <div data-v-37f647ee="" class="content">
          <div data-v-37f647ee="" class="container">
            ...
            <!---->
            <div class="container">
              <button class="btn btn-primary"><a href="add_video.php" class="text-light">Add Video</a></button>
              <table class="table table-bordered text-center my-5">
                ...
                <tbody>
                  ...
                  $sql = "SELECT id, title, video, description, courses, uploader, timestamp FROM videos WHERE is_deleted = 0";
                  ...
                  while ($row = $query_approved->fetch_assoc()) {
                    ...
                    echo '<tr>
                                  ...
                                  <td>
                                    <center>
                                        <a href="' . $video . '" target="_blank">
                                            <img src="' . $thumbnailUrl . '" alt="Video Thumbnail" style="max-width: 200px; max-height: 200px;">
                                        </a>
                                        <br>
                                  ...
                                  <td class="action-column action-buttons" colspan="1">
                                    <button class="btn btn-primary"><a href="update_video.php?updateid=' . $id . '" class="text-light">Update</a></button>
                                  </td>        
                                  <td class="action-column action-buttons" colspan="1">
              ...
              <script>
                ...
                function confirmDelete(id) {
                  ...
                  if (confirm(text)) {
                    window.location = "professor_videos.php?deleteid=" + id;
                  }
                }
              </script>
            </div>
